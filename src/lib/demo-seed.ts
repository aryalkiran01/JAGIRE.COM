...
const DEMO_JOBS: Array<{
...
}> = [
  {
    ...
    description:
      "Build delightful, high-performance user experiences with React, TypeScript, and modern tooling.",
...
const DEMO_REVIEWS = [
  {
    ...
    content: "Smart peers, clear roadmap, healthy work-life balance.",
  },
  {
    rating: 4,
    title: "Solid place to grow",
    content: "Strong mentorship and clear career paths. Comp is competitive.",
  },
  {
    rating: 5,
    title: "Best team I've worked with",
    content: "Fast-moving, kind, and product-obsessed. Highly recommend.",
  },
];
