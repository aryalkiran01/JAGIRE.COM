...
const renderers: Record<string, FieldRenderer> = {
  ...
  original: (v) =>
    typeof v === "string" ? (
      <p className="text-xs text-muted-foreground line-through">{v}</p>
    ) : null,
  ...
  current_level: (v) => (typeof v === "string" ? <p className="text-xs">Current: {v}</p> : null),
  ...
  governance: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">Governance: {v}</p> : null,
  ...
  timeline: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">Timeline: {v}</p> : null,
  target_date: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">Target: {v}</p> : null,
  duration: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">Duration: {v}</p> : null,
  ...
  estimated_hours: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">{v}</p> : null,
  cost_estimate: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">Cost: {v}</p> : null,
  prep_time: (v) =>
  ...
  expected_impact: (v) =>
    typeof v === "string" ? <p className="text-xs text-muted-foreground">Impact: {v}</p> : null,
  current_count: (v) =>
    typeof v === "number" ? <p className="text-xs text-muted-foreground">Current: {v}</p> : null,
  target_count: (v) =>
    typeof v === "number" ? <p className="text-xs text-muted-foreground">Target: {v}</p> : null,
  ...
  skills_demonstrated: (v) => (isStringArray(v) ? <StringList items={v} icon={Target} /> : null),
